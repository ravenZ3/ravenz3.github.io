...
1. **Individual differences.** People vary; the same person varies across time.
2. **Content type.** Melodies stick more stubbornly than forms or colors. Emotions resist vivid re-experience.
3. **Attention and interest.** A single vivid experience (a burn, a humiliation) can create lasting avoidance. Casual encounters slip.
4. **Repetitions.** Multiple exposures build mastery. Additional repetitions build assurance beyond mastery.
5. **Time and decay.** Retention weakens over time without review; even deeply rooted knowledge can fade after disuse.
